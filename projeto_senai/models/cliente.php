...
class Cliente {
    ...
    public function insert($parameters){
        $sql = "INSERT INTO clientes (nomeCliente, emailCliente, senhaCliente, altura, sexo, data, localizacao, caracteristicas, raca) 
                VALUES (:nomeCliente, :emailCliente, :senhaCliente, :altura, :sexo, :data, :localizacao, :caracteristicas, :raca)";
